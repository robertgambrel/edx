...
```
In general, it appears that the day the threshold is met is around day 95-110, which looks reasonable from the graph. I would prefer a somewhat more conservative measure, so I would choose T = 125, C = 2.
